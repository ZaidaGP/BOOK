    ...
    <div class="card ">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="url" value="{{$book->url}}">
            </div>
            <div class="form-group">
                <label for="editorial">Editorial</label>
                <input type="text" class="form-control" name="editorial" value="{{$book->editorial}}">
            </div>
            ...
            <div class="row">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="year_published" value="{{$book->year_published}}">
                </div>
                </div>
                <div class="col-sm-4">
                ...
                <div class="col-sm-4">
                    <button type="submit" class="btn btn-primary icon"> Edit book</a>
                </div><!--cierre col-sm-4-->
                </div> 
            </div>
